...
$(function() {
    ...
    var options = {
        center: {lat: 40.77, lng: -73.965}, // New York, NY
...
function addMarker(place)
{
    ...
    // add expenses info
    $.getJSON("get_expenses.php", parameters)
    .done(function(data, textStatus, jqXHR) {
        ...
        $.each(data, function(index, json_object){
            // create link in html
            content += '<li>' + '<b>$' + json_object["amount"] + '</b>' + ': ' + json_object["date"] + ' - ' + json_object["description"] + '</li>'
            total_amount += parseFloat(json_object["amount"]);
        });

        content += '</ul><p><b>Total: $' + total_amount + '</b></p>';

        console.log("success_expenses");
    })
